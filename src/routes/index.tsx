...
function Index() {
  return (
    <div className="min-h-screen overflow-x-clip bg-background">
      ...
      <section className="relative isolate flex h-svh max-h-[900px] min-h-[600px] items-center overflow-hidden bg-primary text-primary-foreground">
        <img
          src={heroCourthouse}
        ...
        <div className="container relative z-10 flex h-full w-full items-center py-10 pb-24 sm:py-14 sm:pb-28">
          <div className="mx-auto flex max-w-4xl animate-fade-up flex-col items-center text-center">
            ...
            <h1 className="max-w-3xl text-balance text-[clamp(1.75rem,4.5vw,3.25rem)] font-light leading-[1.1] tracking-[-0.015em] text-primary-foreground">
              ...
              <span className="mt-2 block font-semibold text-gold">
                dalle decisioni della PA.
              </span>
            </h1>

            {/* Supporting copy */}
            <p className="mt-5 max-w-2xl text-balance text-sm font-light leading-relaxed text-primary-foreground/70 sm:text-base">
              Espropri sotto valore, ordinanze di demolizione, dinieghi pretestuosi. Verifica in 90 secondi se il tuo caso ha margini reali.
            </p>
